...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<!-- 输入主界面内容 -->
				<h1 class="page-header">查询录音<button type="button" class="btn btn-success" id="search-btn">查询</button></h1>
				...
				<form class="search-form">
					<div class="form-inline row">
						...
						<div class="form-group col-sm-4">
							<label for="agtId" class="col-sm-4">坐席ID</label> <input class="form-control"
								id="agtId" placeholder="" value="81004">
						</div>
					</div>
					
					<div class="form-inline row">
						<div class="form-group col-sm-4">
							<label for="startTime" class="col-sm-4">呼入起始时间</label> <input class="form-control"
								id="startTime" placeholder="yyyy-MM-dd HH:mm:ss" value='2016-02-24 00:00:00'>
						</div>
						<div class="form-group col-sm-4">
							<label for="endTime" class="col-sm-4">呼入结束时间</label> <input class="form-control"
								id="endTime" placeholder="yyyy-MM-dd HH:mm:ss" value="2016-02-24 23:59:59">
						</div>
						<div class="form-group col-sm-4">
								...
								<table border="0" cellpadding="3" cellspacing="0"
									...
									<tr>
										...
										<td nowrap="nowrap" valign="top" align="left"><code>
												<font color="#3f7f5f">//&nbsp;接口地址:
													http://xx.com/VenusRest/webservice/sd-saas/record/getRecordList?accessToken=XXXXXXXX</font><br />
												<font color="#000000">String&nbsp;url&nbsp;=&nbsp;</font><font
													color="#2a00ff">&#34;http://172.16.24.21:9812/VenusRest/webservice/&#34;</font><br />
												<font color="#ffffff">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><font
													color="#000000">+&nbsp;</font><font color="#2a00ff">&#34;sd-saas/record/getRecordList?accessToken=&#34;&nbsp;</font><font
												...
												<font color="#000000">params.put</font><font color="#000000">(</font><font
													...
													color="#000000">)</font><font color="#000000">;</font><br />
												<font color="#000000">params.put</font><font color="#000000">(</font><font
													color="#2a00ff">&#34;agtId&#34;</font><font color="#000000">,&nbsp;</font><font
													color="#2a00ff">&#34;81004&#34;</font><font color="#000000">)</font><font
													color="#000000">;</font><br /> <font color="#000000">params.put</font><font
													color="#000000">(</font><font color="#2a00ff">&#34;endTime&#34;</font><font
													color="#000000">,&nbsp;</font><font color="#2a00ff">&#34;2016-02-24&nbsp;23:59:59&#34;</font><font
													color="#000000">)</font><font color="#000000">;</font><br />
												<font color="#000000">params.put</font><font color="#000000">(</font><font
													color="#2a00ff">&#34;startTime&#34;</font><font
													color="#000000">,&nbsp;</font><font color="#2a00ff">&#34;2016-02-24&nbsp;00:00:00&#34;</font><font
													color="#000000">)</font><font color="#000000">;</font><br />
												<font color="#000000">params.put</font><font color="#000000">(</font><font
													color="#2a00ff">&#34;organizerId&#34;</font><font
						...
						<div role="tabpanel" class="tab-pane" id="tab-3">
							<div class="panel panel-default remark">
								<div class="panel-body">
									&quot;查询录音接口&quot; 是通过 HTTP POST 方法, 并以 JSON 作为参数实体传递到服务器进行调用.<br>
	...
	<script type="text/javascript">
		$($(".nav-sidebar > li")[1]).addClass("active");
		...
		$("#search-btn").click(function() {
			...
			if ($("#agtId").val() != "") data.agtId = $("#agtId").val();
			if ($("#startTime").val() != "") data.startTime = $("#startTime").val();
			if ($("#endTime").val() != "") data.endTime = $("#endTime").val();
			if ($("#organizerId").val() != "") data.organizerId = $("#organizerId").val();
			
			$.ajax({
				type: "POST",
				url: host_url + "/demo/getRecordList.action",
				data: data,
				dataType: "json",
				async: false,
				success: function(result) {
					...
					if (obj.errcode == 0) {
						...
						for (var i = 0; i < list.length; i++) {
							...
							$tr.append($("<td/>").html(item.NAME != null ? item.NAME : "暂无"));
							$tr.append($("<td/>").html(item.ORGANIZER_ID != null ? item.ORGANIZER_ID : "暂无"));
